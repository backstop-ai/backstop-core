...
Evaluate the control surface, learn the operating model, or move directly into a small working adoption. The site follows those decisions instead of mirroring the repository tree.
