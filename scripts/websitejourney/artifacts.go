...
func ExpectedWebsiteJourneys() []Journey {
	return []Journey{
		...
		{GlobalKey: "CAP-013/@UJ-002", CapabilityID: "CAP-013", Tag: "@UJ-002", Title: "Trace all generated product truth to authoritative sources", JLinks: []string{"JLINK-023"}, Hops: []string{"/reference/#cli-command-catalog", "/status/#release-history"}},
