...
func ExpectedWebsiteJourneys() []Journey {
	return []Journey{
		...
		{GlobalKey: "CAP-006/@UJ-001", CapabilityID: "CAP-006", Tag: "@UJ-001", Title: "Distinguish a shipped mechanism from a guarantee", JLinks: []string{"JLINK-006"}, Hops: []string{"/evaluate/#guarantees", "/status/#supported-and-limited"}},
		...
		{GlobalKey: "CAP-007/@UJ-001", CapabilityID: "CAP-007", Tag: "@UJ-001", Title: "Determine whether a named harness, model, or toolchain can operate Backstop", JLinks: []string{"JLINK-008"}, Hops: []string{"/evaluate/#compatibility", "/reference/#compatibility"}},
		{GlobalKey: "CAP-007/@UJ-002", CapabilityID: "CAP-007", Tag: "@UJ-002", Title: "Determine which lifecycle guarantees that compatibility does not preserve", JLinks: []string{"JLINK-009"}, Hops: []string{"/evaluate/#compatibility-limits", "/status/#adjacent-guidance"}},
		...
		{GlobalKey: "CAP-013/@UJ-001", CapabilityID: "CAP-013", Tag: "@UJ-001", Title: "Trace an evaluation claim to its durable source", JLinks: []string{"JLINK-021"}, Hops: []string{"/evaluate/#evidence", "/reference/#source-traceability"}},
		...
		{GlobalKey: "CAP-014/@UJ-002", CapabilityID: "CAP-014", Tag: "@UJ-002", Title: "Confirm that adjacent guidance is not a Backstop guarantee", JLinks: []string{"JLINK-009"}, Hops: []string{"/evaluate/#compatibility-limits", "/status/#adjacent-guidance"}},
	}
}
