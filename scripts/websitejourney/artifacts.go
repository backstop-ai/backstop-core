...
func ExpectedWebsiteJourneys() []Journey {
	return []Journey{
		...
		{GlobalKey: "CAP-011/@UJ-001", CapabilityID: "CAP-011", Tag: "@UJ-001", Title: "Browse the generated installed-pack catalog", JLinks: []string{"JLINK-017"}, Hops: []string{"/pack/examples/#installed-pack-catalog", "/reference/#pack-commands"}},
		...
		{GlobalKey: "CAP-013/@UJ-002", CapabilityID: "CAP-013", Tag: "@UJ-002", Title: "Trace all generated product truth to authoritative sources", JLinks: []string{"JLINK-022", "JLINK-023"}, Hops: []string{"/pack/examples/#installed-pack-catalog", "/reference/#cli-command-catalog", "/status/#release-history"}},
