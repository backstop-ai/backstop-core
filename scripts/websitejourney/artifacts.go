...
func ExpectedWebsiteJourneys() []Journey {
	return []Journey{
		...
		{GlobalKey: "CAP-009/@UJ-001", CapabilityID: "CAP-009", Tag: "@UJ-001", Title: "Move from installation instructions to working configuration guidance", JLinks: []string{"JLINK-012"}, Hops: []string{"/adopt/#install", "/reference/#configuration"}},
		...
		{GlobalKey: "CAP-010/@UJ-002", CapabilityID: "CAP-010", Tag: "@UJ-002", Title: "Connect a use case to an applicable pack", JLinks: []string{"JLINK-016"}, Hops: []string{"/use-cases/#pack-backed-use-cases", "/pack/examples/#choose-a-pack"}},
		{GlobalKey: "CAP-011/@UJ-001", CapabilityID: "CAP-011", Tag: "@UJ-001", Title: "Browse the published pack catalog and install a pack", JLinks: []string{"JLINK-017"}, Hops: []string{"/pack/examples/#install-a-pack", "/reference/#pack-commands"}},
		{GlobalKey: "CAP-011/@UJ-002", CapabilityID: "CAP-011", Tag: "@UJ-002", Title: "Determine which pack addresses a problem and inspect its status", JLinks: []string{"JLINK-018"}, Hops: []string{"/pack/examples/#choose-a-pack", "/status/#pack-direction"}},
		{GlobalKey: "CAP-012/@UJ-001", CapabilityID: "CAP-012", Tag: "@UJ-001", Title: "Decide whether a concern belongs in a pack and start authoring", JLinks: []string{"JLINK-019"}, Hops: []string{"/pack/guide/#pack-or-not", "/reference/#pack-artifact"}},
		{GlobalKey: "CAP-012/@UJ-002", CapabilityID: "CAP-012", Tag: "@UJ-002", Title: "Continue from pack authoring to the contribution path", JLinks: []string{"JLINK-020"}, Hops: []string{"/pack/guide/#author-a-pack", "/contributing/#contribution-paths"}},
		...
		{GlobalKey: "CAP-013/@UJ-002", CapabilityID: "CAP-013", Tag: "@UJ-002", Title: "Trace all generated product truth to authoritative sources", JLinks: []string{"JLINK-022", "JLINK-023"}, Hops: []string{"/pack/examples/#published-pack-catalog", "/reference/#cli-command-catalog", "/status/#release-history"}},
