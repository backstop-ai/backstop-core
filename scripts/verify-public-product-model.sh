...
'docs/pack/examples.md':{
 ...
 'Relock is local-source only. When the pack is ready to ship, publish a tagged release from its repository and add it with `backstop pack add org/pack@version`.':'local pack install guidance'},
'docs/pack/guide.md':{
 ...
 'Publish from the pack repository after check and test pass. Then contribute it.':'author instruction'},
'docs/reference.md':{
