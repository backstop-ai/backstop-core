...
edge_specs=[
('/','define-work','/evaluate/','failure-fit'),('/evaluate/','what-backstop-is','/model/','operating-model'),('/use-cases/','choose-use-case','/evaluate/','fit-decision'),('/evaluate/','fit-decision','/adopt/','install'),('/evaluate/','not-a-fit','/status/','adjacent-guidance'),('/evaluate/','guarantees','/status/','supported-and-limited'),('/status/','boundary-states','/model/','ownership-boundaries'),('/evaluate/','compatibility','/reference/','compatibility'),('/evaluate/','compatibility-limits','/status/','adjacent-guidance'),('/model/','operating-model','/reference/','artifact-schema-catalog'),('/model/','ownership-boundaries','/status/','project-boundaries'),('/adopt/','install','/reference/','configuration'),('/adopt/','verify-enforcement','/model/','enforcement-loop'),('/model/','enforcement-loop','/reference/','gate'),('/use-cases/','choose-use-case','/adopt/','adoption-paths'),('/use-cases/','pack-backed-use-cases','/packs/','choose-a-pack'),('/packs/','installed-pack-catalog','/reference/','pack-commands'),('/packs/','choose-a-pack','/status/','pack-direction'),('/extend/','pack-or-not','/reference/','pack-artifact'),('/extend/','author-a-pack','/contributing/','contribution-paths'),('/evaluate/','evidence','/reference/','source-traceability'),('/packs/','installed-pack-catalog','/reference/','cli-command-catalog'),('/reference/','cli-command-catalog','/status/','release-history'),('/status/','adjacent-guidance','/contributing/','external-ownership')]
...
'docs/evaluate.md':{
 ...
 'CI is a caller. It can run the gate or ignore the exit. Backstop is the verdict that pipeline must honor. Without that, green is still just green.':'visitor decision guidance',
