...
'docs/model.md':{
 'One bundle. Many specs. One plan per spec.':'visitor operating guide',
 ...
 'Packs compose across domains and toolchains.':'visitor operating guide',
 ...
 "Backstop does not own the harness or the language model. It does not own anyone's standards or opinions, or the engines that check them — Semgrep, native toolchains, custom scripts. It does not own your source or your data.":'visitor operating guide',
 'It exists to make agents behave in a disciplined way that gives you the confidence you are getting the software you think you are.':'visitor operating guide',
 '<div class="canonical-note">':'canonical source note',
