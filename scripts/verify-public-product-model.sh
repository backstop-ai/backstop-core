...
'docs/model.md':{
 ...
 '<p class="work-exception"><span>For small fixes</span>A bounded fix skips the bundle and spec. The issue becomes a plan.</p>':'visitor operating guide',
...
'docs/adopt.md':{
 ...
 '<p class="adopt-skip">The rest can wait. None of the pieces is a prerequisite for the others.</p>':'visitor adoption guide',
