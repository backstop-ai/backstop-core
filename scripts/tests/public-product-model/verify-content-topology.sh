...
links=d.get('journey_links',[]); exact_ids(links,'link_id',['JLINK-001','JLINK-002','JLINK-003','JLINK-004','JLINK-007','JLINK-009','JLINK-013','JLINK-015','JLINK-016','JLINK-020','JLINK-023','JLINK-024'],'journey link')
...
labels=['Evaluate the failure fit','See the operating model','Check the fit decision','Install Backstop','See ownership boundaries','Follow compatibility guidance','Understand the enforcement loop','Choose an adoption path','Choose a maintained pack','How to participate','Check release history','Continue outside Backstop']
