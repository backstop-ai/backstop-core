...
owners=['/','/evaluate/','/evaluate/','/status/','/model/','/model/','/use-cases/','/pack/examples/','/pack/guide/','/reference/','/status/','/contributing/']
...
assert d.get('navigation')=={'primary':['/evaluate/','/model/','/adopt/','/pack/','/pack/examples/','/pack/guide/'],'utility':['/contributing/']},'navigation contract'
links=d.get('journey_links',[]); exact_ids(links,'link_id',['JLINK-001','JLINK-002','JLINK-003','JLINK-004','JLINK-005','JLINK-006','JLINK-007','JLINK-008','JLINK-009','JLINK-010','JLINK-011','JLINK-013','JLINK-014','JLINK-015','JLINK-016','JLINK-020','JLINK-021','JLINK-023','JLINK-024'],'journey link')
