...
- [Linux-CI residual family](project_linux_ci_residual_family.md) — ★ 158/163/164/165/166/168/177/180 → DIR-024; ISSUE-180 CONFIRMED it (no TestMain ⇒ re-exec reruns the suite, exit1+"no diagnostic"); pkg/gate RULED OUT; don't close ISSUE-164
...
- [Bundle-maturity join family](project_bundle_maturity_join_family.md) — ★ 057 (floor) + 181 (ceiling) = ONE family; `citing_spec_not_implemented` ALREADY ships the mirror at requirement_traceability.go:107 → DIR-021, not DIR-034
