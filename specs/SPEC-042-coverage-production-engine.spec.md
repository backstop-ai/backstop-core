...
- **1.1.0** (2026-07-03) — Status → `implemented`. The BUNDLE-011 Seed 4 code shipped
  and was committed; the parent bundle BUNDLE-011 is `delivered`. No requirement, claim,
  or contract text changed — lifecycle transition only.
- **1.0.0** (2026-06-24) — Initial spec authored from BUNDLE-011 Seed 4.
